...
can_bob_and_john_enter = bobs_age > 17 and johns_age > 17

# Checking if either Alice or Mike can enter the park (at least one must be an adult)
can_alice_or_mike_enter = alices_age > 17 or mikes_age > 17

# Checking if Bob, Alice, and John can all enter the park together (all must be adults)
can_bob_alice_john_enter = bobs_age > 17 and alices_age > 17 and johns_age > 17
